    ...
    <a-card :bordered="false">
      ...
      >
        ...
        <span slot="streamMode" slot-scope="text, record">
          <a-select  :defaultValue= "text" style="width: 120px" @change ="value => updateStreamMode(value,record) ">
...
import {deleteDevice, getDeviceList, queryGBDeviceById, updateDeviceInfo,updateStreamMode} from "@/api/deviceList";
...
export default {
  ...
  methods: {
    updateStreamMode(value,record){
      if(!!value){
        const requestParameters = Object.assign({});
        requestParameters.deviceId = record.deviceId;
        requestParameters.streamMode = value;
        return updateStreamMode(requestParameters).then(res => {
          console.log(res);
        }).catch(error =>{
          console.log(error);
        })
