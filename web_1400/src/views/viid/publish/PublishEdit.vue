    ...
    <el-card class="box-card" shadow="always">
        <div slot="header" class="clearfix">
            ...
            <el-button-group style="float: right;">
                <el-button v-hasPerm="['viid:publish:edit']" size="mini" icon="el-icon-plus" round
...
import { getPublish, updatePublish } from '@/api/datawork/viid/publish'

export default {
    name: 'VIIDPublishEdit',
    props: {
        data: {
            type: Object,
            default: function () {
    ...
    created() {
        ...
        getPublish(this.data.id).then(response => {
