        ...
        <div class="body-wrapper">
            <el-form ref="form" :model="form" :rules="rules" label-width="110px">
                ...
                <el-form-item label="车道ID" prop="laneId">
                    <el-input type="number" v-model="form.laneId" placeholder="请输入车道ID" :disabled="true" />
                </el-form-item>
...
<script>
import { updateLane, getLane } from '@/api/datawork/viid/lane'
...
export default {
    ...
    created() {
        ...
        getLane(this.data.id).then(response => {
