  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'streamPush',
        component: RouteView,
        redirect: '/stream/push',
        meta: {title: 'menu.video.stream-push-manage', icon: 'deployment-unit'},
        children: [
          {
            path: '/stream/push',
            name: 'streamPushList',
            component: () => import(/* webpackChunkName: "fail" */ '@/views/streamPush/StreamPushList'),
            meta: {title: 'menu.video.stream-push-list'}
          }
        ]
      },
      {
