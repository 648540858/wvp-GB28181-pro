<template>
  <div ref="videoRoot" style="margin-top: 10px">
    ...
    <a-row type="flex" :gutter="[1, 2]">
      ...
      <a-col :flex="1">
        <div ref="container9" style="background-color: #000" @click="selectContainer(9)" @mouseleave="mouseLeave(9)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container10" style="background-color: #000" @click="selectContainer(10)" @mouseleave="mouseLeave(10)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container11" style="background-color: #000" @click="selectContainer(11)" @mouseleave="mouseLeave(11)"></div>
      </a-col>
    </a-row>

    <a-row type="flex" :gutter="[1, 2]">
      <a-col :flex="1">
        <div ref="container12" style="background-color: #000" @click="selectContainer(12)" @mouseleave="mouseLeave(12)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container13" style="background-color: #000" @click="selectContainer(13)" @mouseleave="mouseLeave(13)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container14" style="background-color: #000" @click="selectContainer(14)" @mouseleave="mouseLeave(14)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container15" style="background-color: #000" @click="selectContainer(15)" @mouseleave="mouseLeave(15)"></div>
      </a-col>
    </a-row>
