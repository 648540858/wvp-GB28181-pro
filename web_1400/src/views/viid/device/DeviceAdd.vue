    ...
    <el-card class="box-card" shadow="always">
        <div slot="header" class="clearfix">
            ...
            <el-button-group style="float: right;">
                <el-button v-hasPerm="['viid:apedevice:add']" size="mini" icon="el-icon-plus" round
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="110px">
                <el-tooltip class="item" effect="dark" content="国标格式设备编号(6位地区编码+0000132+7位随机数)设备唯一不可重复" placement="top">
                    <el-form-item label="设备标识" prop="apeId">
                        <el-input v-model="form.apeId" placeholder="请输入设备标识" />
                    </el-form-item>
                </el-tooltip>
...
<script>
import { addApeDevice } from '@/api/datawork/viid/apedevice'
        ...
        submitForm: function () {
            this.$refs['form'].validate(valid => {
                if (valid) {
                    ...
                    addApeDevice(this.form).then(response => {
                        if (response.success) {
