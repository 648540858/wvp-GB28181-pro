    ...
    <el-card class="box-card" shadow="always">
        <div slot="header" class="clearfix">
            ...
            <el-button-group style="float: right;">
                <el-button v-hasPerm="['viid:server:add']" size="mini" icon="el-icon-plus" round
        ...
        <div class="body-wrapper">
            <el-form ref="form" :model="form" label-width="100px">
                <el-form-item label="视图库编号" prop="serverId">
                    <el-input v-model="form.serverId" placeholder="请输入视图库编号" />
                </el-form-item>
                ...
                <el-form-item label="数据传输类型" prop="transmission">
                    <el-select v-model="form.transmission" placeholder="请选择数据传输类型">
                        ...
                        <el-option label="设备直推协议" value="device"></el-option>
                    </el-select>
                </el-form-item>
...
<script>
import { upsertServer } from '@/api/datawork/viid/server'
