    ...
    <el-card class="box-card" shadow="always">
        <div slot="header" class="clearfix">
            ...
            <el-button-group style="float: right;">
                <el-button v-hasPerm="['viid:subscribe:add']" size="mini" icon="el-icon-plus" round
...
import { addSubscribe } from '@/api/datawork/viid/subscribe'

export default {
    name: 'VIIDSubscribeAdd',
    props: {
        data: {
            type: Object,
            default: function () {
                      ...
                      if (responseStatusObjects) {
                        for (let index in responseStatusObjects) {
                          ...
                          if (responseStatusObject.StatusCode == '0') {
                            ...
                            this.$message.error('订阅失败:' + responseStatusObject.statusString)
