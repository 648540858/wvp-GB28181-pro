...
public class SIPCommander implements ISIPCommander {
    ...
    public void playStreamCmd(Device device, String channelId, ZLMHttpHookSubscribe.Event event, SipSubscribe.Event errorEvent) {
        ...
        try {
            ...
            streamSession.putClientTransaction(channelId, streamId, transaction);
        } catch (SipException | ParseException | InvalidArgumentException e) {
            logger.error("请求直播失败", e);
     ...
     */
    @Override
    public void stopStreamByeCmd(StreamInfo streamInfo, SipSubscribe.Event okEvent) {
        String channelId = streamInfo.getChannelId();
        String streamId = streamInfo.getStreamId();
        ClientTransaction transaction = streamSession.getClientTransaction(channelId, streamId);
        // wvp信令服务重启后
        if (transaction == null) {
