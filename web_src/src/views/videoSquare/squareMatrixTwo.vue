<template>
  <div ref="videoRoot" style="margin-top: 10px">
    <a-row type="flex" :gutter="[1,2]">
      <a-col :flex="1">
        <div ref="container0" style="background-color: #000" @click="selectContainer(0)"
             @mouseleave="mouseLeave(0)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container1" style="background-color: #000" @click="selectContainer(1)"
             @mouseleave="mouseLeave(1)"></div>
      </a-col>
    </a-row>
    <a-row type="flex" :gutter="[1, 2]">
      <a-col :flex="1">
        <div ref="container2" style="background-color: #000" @click="selectContainer(2)"
             @mouseleave="mouseLeave(2)"></div>
      </a-col>
      <a-col :flex="1">
        <div ref="container3" style="background-color: #000" @click="selectContainer(3)"
             @mouseleave="mouseLeave(3)"></div>
      </a-col>
    </a-row>
  </div>
</template>
