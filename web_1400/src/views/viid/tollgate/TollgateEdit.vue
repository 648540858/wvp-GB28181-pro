    ...
    <el-card class="box-card" shadow="always">
        <div slot="header" class="clearfix">
            ...
            <el-button-group style="float: right;">
                <el-button v-hasPerm="['viid:tollgate:edit']" size="mini" icon="el-icon-plus" round
        ...
        <div class="body-wrapper">
            <el-form ref="form" :model="form" :rules="rules" label-width="110px">
                <el-form-item label="卡口标识" prop="tollgateId">
                    <el-input v-model="form.tollgateId" placeholder="请输入卡口标识" :disabled="true" />
                </el-form-item>
                ...
                <el-form-item label="车道数量" prop="laneNum">
...
<script>
import { getTollgate, updateTollgate } from '@/api/datawork/viid/tollgate'
import { getDeviceOptions } from '@/api/datawork/viid/apedevice'

export default {
    name: 'VIIDTollgateEdit',
    props: {
        data: {
            type: Object,
            default: function () {
    ...
    created() {
        getTollgate(this.data.id).then(response => {
            this.form = response.data
            this.loadDeviceOptions(null, this.form.deviceId)
        })
    },
    methods: {
        showCard() {
        ...
        submitForm: function () {
            this.$refs['form'].validate(valid => {
                if (valid) {
                    ...
                    updateTollgate(this.form).then(response => {
                        if (response.success) {
